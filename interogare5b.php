...
<?php
	...
	$sql = "CALL get_distinct_non_kongo_ships('$Clasa')";
	...
	while ($row = $result->fetch_assoc()) {
		printf("<tr><td>%s</td></tr>", $row['NUME']);
	}
	echo "</table>";
?>

	<form action="interogare5b.html" method="post">
